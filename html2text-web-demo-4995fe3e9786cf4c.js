...
export class Config {
    ...
    use_colour() {
        wasm.config_use_colour(this.__wbg_ptr);
    }
    use_css() {
        wasm.config_use_css(this.__wbg_ptr);
    }
}
...
async function __wbg_init(module_or_path) {
    ...
    if (typeof module_or_path === 'undefined') {
        module_or_path = new URL('html2text-web-demo_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
